...
class Bill_App:
    def __init__(self,root):
        ...
        F2.place(y=180,width=325,height=360)
        ...
        search_no_btn=Button(F2,command=self.search_item,bg="Blue",text="Search",fg="Black",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=1,column=1,padx=5,pady=5)

        #============Item Details===============#

        F3=LabelFrame(self.root,bd=10,relief=GROOVE, text="Item Details",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
        F3.place(x=340,y=180,width=325,height=360)
        ...
        search_name_btn=Button(F3,command=self.add_item,bg="Blue",text="Add",fg="Black",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=4,column=1,padx=5,pady=5)


        #============Shopping Cart===============#

        F4=LabelFrame(self.root,bd=10,relief=GROOVE, text="Shopping Cart",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
        F4.place(x=740,y=180,width=350,height=360)
        ...
        F5.place(x=1100,y=180,width=400,height=360)
        ...
        btn_F.place(x=780,width=715,height=120)

        total_btn=Button(btn_F,command=self.find_bill,bg="Blue",text="Total",fg="Black",pady=15,width=11,bd=5,font="arial 15 bold").grid(row=0,column=0,padx=5,pady=5)
    ...
    def search_item(self):
        if self.search_item_no.get()=="":
            ...
            return
        con=pymysql.connect(host="localhost",user="root",password="Chkrishna@1",database="ims")
        cur=con.cursor()
