...
class Stock:
    ...
    def update_data(self):
        ...
        cur=con.cursor()
        # statement=
        cur.execute(f"update stocks set item_no='{self.item_no.get()}', qty='{self.item_qty.get()}', price='{self.item_price.get()}',name='{self.item_name.get()}' where item_no='{self.item_no.get()}'")
        con.commit()
        self.fetch_date()
        self.clear()
        con.close()
